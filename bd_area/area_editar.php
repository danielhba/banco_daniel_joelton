...
if(isset($_POST["validar"])){
	...
	else
	{
		...
		if(mysql_num_rows($result) == 1)
		{
			if(isset($_POST["codigo"]))
			{
				...
				{
					$error = true;
					$error_nome = '<font color = "red">Este nome de área já está cadastrado. Digite outro.</font>';
				}
			}
			else
			{
	...
	if($error == false)
	{
		...
		?>
<center>
<h2><?php  echo isset($_POST['codigo'])? "Edição de área" : "Cadastro de área";?></h2>
</center>
...
<form name="form1" method="POST" action="area_editar.php"><?php 
if(isset($_GET["codigo"]))
{
