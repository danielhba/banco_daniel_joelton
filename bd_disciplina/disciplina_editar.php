<html><head><title><?php 
echo (isset($_GET["codigo"]) || isset($_POST["codigo"])) ? "Editar Disciplina": "Cadastrar Disciplina"?>
</title>
</head>
<body>
...
?>
<center>
<h2><?php  echo isset($_POST['codigo'])? "Edição de disciplina" : "Cadastro de disciplina";?></h2></center>

<center>
<h3><?php  echo isset($_POST[' codigo']) ? " Confirmação de edição":"Confirmação de cadastro de disciplina";?></h3></center>
